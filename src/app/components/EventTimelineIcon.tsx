...
export const EventTimelineIcon = ({
  ...
  if (event.type === 'CHAMPION_KILL' && event.killerId === myParticipantId) {
    return (
      ...
      >
        <ChampIcon size={ICON_SIZE} championId={participants[(event.victimId || 0) - 1].championId} />
      </div>
    );
  }
  ...
  if (event.type === 'ELITE_MONSTER_KILL') {
    ...
    if (event.monsterType === 'BARON_NASHOR') {
      return (
        ...
        >
          <img
            src={'https://raw.communitydragon.org/latest/game/assets/characters/sru_baron/hud/baron_square.png'}
            height={ICON_SIZE}
            width={ICON_SIZE}
          />
        </div>
      ...
      return (
        ...
        >
          <img
            src={'https://raw.communitydragon.org/latest/game/assets/characters/sru_dragon/hud/dragon_square.png'}
            height={ICON_SIZE}
            width={ICON_SIZE}
          />
        </div>
